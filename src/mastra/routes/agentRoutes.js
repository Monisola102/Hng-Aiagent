const { registerApiRoute } = require("@mastra/core/server");
    ...
    try {
      ...
      const response = await agent.generate(mastraMessages, async () => {
        ...
        return {
          ...
          fat,
          carbs,
          vitamins: vitamins.length ? vitamins : null,
          minerals: minerals.length ? minerals : null,
          healthBenefits,
...
module.exports = { foodInfoAgentRoute };
